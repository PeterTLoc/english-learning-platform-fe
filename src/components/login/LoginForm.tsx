...
interface Props {
  ...
  onGoogleLogin?: () => void; // Optional Google login handler
}
        ...
        {onGoogleLogin && (
          <div className="mb-4">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-900 font-medium py-2.5 px-4 rounded-md border border-gray-300 transition-colors"
            >

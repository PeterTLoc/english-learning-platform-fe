...
export default function CourseCard({
  ...
  return (
    <Link href={href}>
      <div className="relative h-64 mt-1 rounded-md overflow-hidden shadow-md group transform transition duration-300 ease-in-out hover:-translate-y-1 cursor-pointer">
        <img
          src={imageUrl}
          alt={title}
